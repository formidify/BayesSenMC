...
namespace model_randCorr_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_randCorr");
    reader.add_event(56, 54, "end", "model_randCorr");
    return reader;
}
#include <stan_meta_header.hpp>
class model_randCorr
  : public stan::model::model_base_crtp<model_randCorr> {
private:
        int a;
        int N1;
        int c;
        ...
        double sLOR_c;
public:
    model_randCorr(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_randCorr_namespace::model_randCorr";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "mZ", "double", context__.to_vec());
            mZ = double(0);
            vals_r__ = context__.vals_r("mZ");
            pos__ = 0;
            mZ = vals_r__[pos__++];
            current_statement_begin__ = 11;
            context__.validate_dims("data initialization", "sZ", "double", context__.to_vec());
            sZ = double(0);
            vals_r__ = context__.vals_r("sZ");
            pos__ = 0;
            sZ = vals_r__[pos__++];
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            local_scalar_t__ rhoSe;
            (void) rhoSe;  // dummy to suppress unused var warning
            stan::math::initialize(rhoSe, DUMMY_VAR__);
            stan::math::fill(rhoSe, DUMMY_VAR__);
            ...
            stan::math::assign(rhoSe, ((stan::math::exp((2 * Z)) - 1) / (1 + stan::math::exp((2 * Z)))));
            ...
            current_statement_begin__ = 30;
            if (stan::math::is_uninitialized(rhoSe)) {
                std::stringstream msg__;
                msg__ << "Undefined transformed parameter: rhoSe";
                stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable rhoSe: ") + msg__.str()), current_statement_begin__, prog_reader__());
            }
            current_statement_begin__ = 31;
            ...
            lp_accum__.add(normal_log<propto__>(Z, mZ, sZ));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_randCorr_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_randCorr_namespace::model_randCorr stan_model;
#ifndef USING_R
