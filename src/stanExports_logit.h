...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(46, 44, "end", "model_logit");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "mX", "double", context__.to_vec());
            mX = double(0);
            vals_r__ = context__.vals_r("mX");
            pos__ = 0;
            mX = vals_r__[pos__++];
            current_statement_begin__ = 7;
            context__.validate_dims("data initialization", "mY", "double", context__.to_vec());
            mY = double(0);
            vals_r__ = context__.vals_r("mY");
            pos__ = 0;
            mY = vals_r__[pos__++];
            current_statement_begin__ = 8;
            context__.validate_dims("data initialization", "sdX", "double", context__.to_vec());
            sdX = double(0);
            vals_r__ = context__.vals_r("sdX");
            pos__ = 0;
            sdX = vals_r__[pos__++];
            current_statement_begin__ = 9;
            context__.validate_dims("data initialization", "sdY", "double", context__.to_vec());
            sdY = double(0);
            vals_r__ = context__.vals_r("sdY");
            pos__ = 0;
            sdY = vals_r__[pos__++];
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(Se, ((1 + (stan::math::exp(X) / (1 + stan::math::exp(X)))) / 2));
            current_statement_begin__ = 30;
            stan::math::assign(Sp, ((1 + (stan::math::exp(Y) / (1 + stan::math::exp(Y)))) / 2));
            ...
            lp_accum__.add(normal_log<propto__>(X, mX, sdX));
            current_statement_begin__ = 39;
            lp_accum__.add(normal_log<propto__>(Y, mY, sdY));
