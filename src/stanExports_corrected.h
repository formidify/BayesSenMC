...
namespace model_corrected_namespace {
using std::istream;
using std::string;
...
class model_corrected
  : public stan::model::model_base_crtp<model_corrected> {
private:
        int a;
        int N1;
        int c;
        ...
        double sLOR_c;
public:
    model_corrected(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_corrected_namespace::model_corrected";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "Se", "double", context__.to_vec());
            Se = double(0);
            ...
            context__.validate_dims("data initialization", "Sp", "double", context__.to_vec());
            Sp = double(0);
            vals_r__ = context__.vals_r("Sp");
            pos__ = 0;
            Sp = vals_r__[pos__++];
...
typedef model_corrected_namespace::model_corrected stan_model;
#ifndef USING_R
