...
namespace model_crude_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_crude");
    reader.add_event(30, 28, "end", "model_crude");
    return reader;
}
#include <stan_meta_header.hpp>
class model_crude
  : public stan::model::model_base_crtp<model_crude> {
private:
        int a;
        int N1;
        int c;
        ...
        double sLOR_c;
public:
    model_crude(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_crude_namespace::model_crude";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(binomial_log<propto__>(a, N1, pi1));
            current_statement_begin__ = 25;
            lp_accum__.add(binomial_log<propto__>(c, N0, pi0));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_crude_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_crude_namespace::model_crude stan_model;
#ifndef USING_R
